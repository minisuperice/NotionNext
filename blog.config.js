...
const BLOG = {
  ...
  NOTION_HOST: process.env.NEXT_PUBLIC_NOTION_HOST || 'https://minisuperice.notion.site/e169b3b2ec9948a2a513eaa4ef98f66e', // Notion域名，您可以选择用自己的域名进行反向代理，如果不懂得什么是反向代理，请勿修改此项
